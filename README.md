...
- [Halopen](https://halopen.com/) - Hold-to-talk dictation from the menu bar that types what you said into any app, with an on-device mode that keeps audio on your Mac.
